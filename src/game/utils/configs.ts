...
const config = {
    ...
    TREX_CANVAS_LOCATION: new Vector2D(200, 368),
    ...
    CACTUS_VELOCITY_Y: 0,
    CACTUS_CANVAS_LOCATION: new Vector2D(1500, 365),

    BIRD_VELOCITY_X: 450,
    BIRD_VELOCITY_Y: 0,
    BIRD_HIGH_CANVAS_LOCATION: new Vector2D(1500, 350),
    BIRD_LOW_CANVAS_LOCATION: new Vector2D(1500, 375),
    BIRD_CHANGING_INTERVAL: 300,

    GROUND_VELOCITY_X: 450,
    GROUND_VELOCITY_Y: 0,
    GROUND_CANVAS_LOCATION: new Vector2D(0, 400),

    CLOUD_VELOCITY_X: 200,
    CLOUD_VELOCITY_Y: 0,
    CLOUD_CANVAS_LOCATION: new Vector2D(1500, 340),
    CLOUD_GENERATING_INTERVAL: 3000,
    CLOUD_LOW_Y: 270,
    CLOUD_HIGH_Y: 340,

    SCOREBOARD_CANVAS_LOCATION: new Vector2D(1000, 250),
